[<AutoOpen>]
module Dap.Context.AsyncHandlersExtension

open Dap.Prelude
open Dap.Context
open Dap.Context.Internal

type IAsyncHandlers with
...
type IAsyncHandlers with
    member this.AddJsonJson key = this.Add<Json, Json> (E.json, D.json, E.json, D.json, key)
    member this.AddJsonUnit key = this.Add<Json, unit> (E.json, D.json, E.unit, D.unit, key)
    member this.AddJsonBool key = this.Add<Json, bool> (E.json, D.json, E.bool, D.bool, key)
    member this.AddJsonString key = this.Add<Json, string> (E.json, D.json, E.string, D.string, key)
    member this.AddJsonInt key = this.Add<Json, int> (E.json, D.json, E.int, D.int, key)
    member this.AddJsonLong key = this.Add<Json, int64> (E.json, D.json, E.long, D.long, key)
    member this.AddJsonFloat key = this.Add<Json, float> (E.json, D.json, E.float, D.float, key)
    member this.AddJsonDecimal key = this.Add<Json, decimal> (E.json, D.json, E.decimal, D.decimal, key)

type IAsyncHandlers with
    member this.AddUnitJson key = this.Add<unit, Json> (E.unit, D.unit, E.json, D.json, key)
...
type IAsyncHandlers with
    member this.AddBoolJson key = this.Add<bool, Json> (E.bool, D.bool, E.json, D.json, key)
...
type IAsyncHandlers with
    member this.AddStringJson key = this.Add<string, Json> (E.string, D.string, E.json, D.json, key)
...
type IAsyncHandlers with
    member this.AddIntJson key = this.Add<int, Json> (E.int, D.int, E.json, D.json, key)
...
type IAsyncHandlers with
    member this.AddLongJson key = this.Add<int64, Json> (E.long, D.long, E.json, D.json, key)
...
type IAsyncHandlers with
    member this.AddFloatJson key = this.Add<float, Json> (E.float, D.float, E.json, D.json, key)
...
type IAsyncHandlers with
    member this.AddDecimalJson key = this.Add<decimal, Json> (E.decimal, D.decimal, E.json, D.json, key)
